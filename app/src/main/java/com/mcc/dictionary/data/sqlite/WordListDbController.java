...
public class WordListDbController {
    private SQLiteDatabase db;

    public WordListDbController(Context context) {
    ...
    public int insertData(String postWord, String postMeaning, String postType, String postSynonym, String postAntonym, String postExample) {
        ...
        return (int) db.insert(
                DbConstants.WORD_LISTS_TABLE_NAME,
    ...
    public ArrayList<WordDetail> getAllData() {
        ...
        Cursor c = db.query(
                DbConstants.WORD_LISTS_TABLE_NAME,  // The table name to query
    ...
    private ArrayList<WordDetail> fetchData(Cursor c) {
        ArrayList<WordDetail> hisDataArray = new ArrayList<>();
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    hisDataArray.add(new WordDetail(itemId, word, meaning, type, synonym, antonym, example));
                } while (c.moveToNext());
            }
            c.close();
        }
